function [s11,s22,s33,s12,s23,s31,wp] = importfile1(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as column vectors.
%   [S11,S22,S33,S12,S23,S31,WP] = IMPORTFILE1(FILENAME) Reads data from
%   text file FILENAME for the default selection.
%
%   [S11,S22,S33,S12,S23,S31,WP] = IMPORTFILE1(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [s11,s22,s33,s12,s23,s31,wp] = importfile1('output.txt',2, 5);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/07/02 14:09:32
...
formatSpec = '%16s%16s%16s%16s%16s%16s%s%[^\n\r]';
